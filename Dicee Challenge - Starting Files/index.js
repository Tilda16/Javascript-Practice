...
function winner() {
  if(randomNumber1 > randomNumber2){
    document.querySelector(".container .title").innerHTML = "Player 1 Wins! Hooray!";
  }
  else if (randomNumber1 === randomNumber2){
    document.querySelector(".container .title").innerHTML = "It's a draw!";
  }
else {
  document.querySelector(".container .title").innerHTML = "Player 2 Wins! Hooray!";
}
}
